class AgentController < ApplicationController
  ...
  def viewapproach
    ...
    #@approachlist=Approach.where(property_id:@property.id).all #@property.approaches
    @approachlist=@property.approaches
    if @property.rented == 1  
  ...
  def addapproach
    ...
    @approach=Approach.new()
    #finding property with the params
    @property=Property.find(params[:id])
    @renter=current_renter
    #adding to the approaches
